...
config :agent_lens, AgentLensWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "XiHUfqEckx+Q9AmZq4GscGP1865WLfMCQtYm2F1H0X/B6UVAXnENr5BqILN3eqZi",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:agent_lens, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:agent_lens, ~w(--watch)]}
  ]
...
config :agent_lens, dev_routes: true
